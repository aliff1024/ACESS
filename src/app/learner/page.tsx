...
export default function LearnerDashboardPage() {
  ...
  if (activePreset === 'adhd') {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 space-y-8 readable-content">
        <section>
          <WelcomeSection />
        </section>
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 space-y-12 readable-content">
        ...
        <section className="bg-card p-6 rounded-2xl border border-border">
          <h2 className="text-xl font-semibold mb-2">{t('dashboard.youreDoingGreat')}</h2>
          <p className="text-muted-foreground mb-4">{t('dashboard.youreDoingGreatDesc')}</p>
