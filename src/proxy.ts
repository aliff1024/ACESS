...
const PUBLIC_ROUTES = ['/', '/login', '/signup', '/access-denied', '/forgot-password', '/reset-password', '/contact', '/become-instructor', '/become-instructor/apply', '/auth/callback', '/auth/verify-recovery', '/api/auth/forgot-password', '/api/auth/reset-password', '/api/public-stats', '/api/instructor-applications'];
